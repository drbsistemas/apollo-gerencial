inherited Fcad_PlanoConta: TFcad_PlanoConta
  ...
  inherited pnCon: TPanel [1]
    ...
    inherited grConsulta: TcxGrid
      ...
      inherited grConsultaDBTableView1: TcxGridDBTableView
        DataController.DataSource = dmCad.dsPlanoConta
  ...
  inherited pnCad: TPanel [2]
    ...
    object cxTipoPlano: TcxComboBox
      Left = 117
      Top = 146
      ParentFont = False
      Properties.CharCase = ecUpperCase
      ...
      Properties.Items.Strings = (
        '1 - RECEITAS'
        '2 - DESPESAS - CUSTOS VARIAVEIS'
        '3 - DESPESAS - CUSTOS FIXOS'
        '4 - DESPESAS - EXTRA OPERACION.')
      Style.Font.Charset = ANSI_CHARSET
      Style.Font.Color = clWindowText
      Style.Font.Height = -11
    ...
    object cxLabel4: TcxLabel
      Left = 42
      Top = 170
      Caption = 'Participa DRE:'
      Style.TextColor = clBlack
      Transparent = True
    end
    object cxDre: TcxComboBox
      Left = 117
      Top = 168
      ParentFont = False
      Properties.CharCase = ecUpperCase
    ...
    object cxGrid1: TcxGrid
      ...
      object cxGridDBTableView1: TcxGridDBTableView
        ...
        DataController.DataSource = dmCad.dsPlanoContaItem
    ...
    object cxLabel7: TcxLabel
      ...
      Top = 210
      AutoSize = False
      Caption = 'Rateio Percentual do Centro de Custo'
      ParentFont = False
      Style.Font.Charset = ANSI_CHARSET
      Style.Font.Color = clMaroon
      Style.Font.Height = -11
    ...
    object eTotalPerc: TcxCurrencyEdit
      Left = 353
      Top = 249
      Hint = 'Percentual'
      TabStop = False
