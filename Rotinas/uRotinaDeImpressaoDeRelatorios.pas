unit uRotinaDeImpressaoDeRelatorios;
...
Uses
  ...
  StdCtrls, IniFiles, WinProcs, Menus,
   ...
   procedure CriaDmRel;
   procedure Imprime(dsNome, dsNome2, dsNome3: TDataSource; Preview, Caption, LocalArquivo, TrocaImp, EnviaEmail: String; Copias: Integer);
...
begin
   ...
   if dsNome3 <> nIl then
   begin
      dmrel.dbPipeAux3.DataSOurce              := dsNome3;
      dmRel.dbPipeAux3.Active;
   end;
