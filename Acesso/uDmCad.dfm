object dmCad: TdmCad
  ...
  object UpdtConf: TFDUpdateSQL
    ...
    InsertSQL.Strings = (
      'INSERT INTO CONF'
      '(IDCONF, KEYGEN, RAZAOEMP, FANTASIAEMP, CNPJEMP, '
      ...
      '  DATAULTIMOACESSO, ATIVO)'
      
        'VALUES (:NEW_IDCONF, :NEW_KEYGEN, :NEW_RAZAOEMP, :NEW_FANTASIAEM' +
        'P, :NEW_CNPJEMP, '
      ...
      '  :NEW_CEPEMP, :NEW_CONTATOEMP, :NEW_FONEEMP, :NEW_EMAILEMP, '
        ...
        'MAIL, '
      '  :NEW_DATAULTIMOACESSO, :NEW_ATIVO)'
        ...
        'MAIL, DATAULTIMOACESSO, ATIVO')
    ModifySQL.Strings = (
      'UPDATE CONF'
      
        'SET IDCONF = :NEW_IDCONF, KEYGEN = :NEW_KEYGEN, RAZAOEMP = :NEW_' +
        'RAZAOEMP, '
      '  FANTASIAEMP = :NEW_FANTASIAEMP, CNPJEMP = :NEW_CNPJEMP, '
      
        '  IEEMP = :NEW_IEEMP, ENDERECOEMP = :NEW_ENDERECOEMP, NUMEROEMP ' +
        '= :NEW_NUMEROEMP, '
      
        '  COMPLEMENTOEMP = :NEW_COMPLEMENTOEMP, BAIRROEMP = :NEW_BAIRROE' +
        'MP, '
      '  IIEMUNEMP = :NEW_IIEMUNEMP, CIDADEEMP = :NEW_CIDADEEMP, '
      
        '  UFEMP = :NEW_UFEMP, CEPEMP = :NEW_CEPEMP, CONTATOEMP = :NEW_CO' +
        'NTATOEMP, '
      
        '  FONEEMP = :NEW_FONEEMP, EMAILEMP = :NEW_EMAILEMP, SITEEMP = :N' +
        'EW_SITEEMP, '
      '  DATABACKUP = :NEW_DATABACKUP, VALIDADELIC = :NEW_VALIDADELIC, '
